...
class shippmentOption(models.Model):
    shippment_carrier           = models.CharField(max_length=20)
    shippment_service_carrier   = models.CharField(max_length=255)
    shippment_cost              = models.DecimalField(max_digits=5, decimal_places=3)

    def __str__(self):
        return self.shippment_service_carrier
...
class Order(TimeStampedModel):
    ...
    shippment           = models.ForeignKey(shippmentOption, on_delete=models.CASCADE, blank=True, null=True)
